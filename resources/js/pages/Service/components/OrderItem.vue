...
<template>
    <div class="p-4 border-b border-gray-200 last:border-0 flex flex-row items-center ">
        ...
        <div class="flex items-center justify-between w-full">
            ...
            <div>
                <p>Стол: {{ props.orderItem.order.table.number }}</p>
                ...
                <button v-if="props.servedOrder" @click="props.servedOrder(props.orderItem.id)" class="ml-4 px-3 py-1 bg-green-500 text-white rounded cursor-pointer">
                    Served
                </button>
            <div>
        </div>
